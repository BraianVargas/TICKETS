...
<div class="row mt-4">
    <form class="col-12"  role="form" method="POST" action="{{ url('/create_ticket') }}">
        ...
        {{-- if the page reload from the create route show a modal with a success message --}}
        ...
        <div class="col-12 bg-white rounded-3 shadow">
            @if($client == null)
                ...
                <div class="row m-2 p-3 rounded-3  justify-content-center text-center">
                    ...
                    <div class="alert alert-warning" role="alert">
                        <strong>BUSCAR USUARIO PREVIO A LA CARGA DEL RECLAMO</strong>
                    </div>
                    <a href="{{url('/searchUserByDni')}}" class="btn btn-success col-12">
            ...
            @else
                ...
                <div class="row m-2 p-3 rounded-3  justify-content-center text-center">
                    <h3 class="col-12 text-decoration-none">Datos del Cliente</h3>
                    <div class="form-floating col-12 col-md-4 mt-3 mb-1 m-auto">
                        <input value="{{$client->name_denunciante}}" disabled type="text" id="name_denunciante" name="name_denunciante" class="form-control col-12" required>
                        <label class="" for="name_denunciante">Nombre</label>
                    </div>
                    <div class="form-floating col-12 col-md-4 mt-3 mb-1 m-auto">
